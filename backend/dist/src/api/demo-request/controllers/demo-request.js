...
exports.default = strapi_1.factories.createCoreController('api::demo-request.demo-request', ({ strapi }) => ({
    async create(ctx) {
        ...
        if (country === 'Thailand')
            to = 'info.thailand@tactlink.com';
        else if (country === 'Indonesia')
            to = 'info.indonesia@tactlink.com';
        else if (country === 'Cambodia')
            to = 'info.cambodia@tactlink.com';
        else if (country === 'Malaysia')
            to = 'info.malaysia@tactlink.com';
        else if (country === 'Vietnam')
            to = 'info.vietnam@tactlink.com';
        // Send email
