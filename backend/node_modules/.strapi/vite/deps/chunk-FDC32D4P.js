import {
  ...
  QueryClientProvider,
  img
} from "./chunk-WCZ7LW4M.js";
import {
  ADMIN_PERMISSIONS_CE,
  HOOKS
} from "./chunk-IQXWKXLM.js";
import {
  useNpsSurveySettings
} from "./chunk-TB2G3DA2.js";
import {
  GuidedTourProvider,
  useGuidedTour
} from "./chunk-6JJCSSON.js";
import {
  UnstableGuidedTourContext
} from "./chunk-JHCKTRED.js";
import {
  require_pick
} from "./chunk-FTOCBLLO.js";
import {
  getBasename
} from "./chunk-QIJGNK42.js";
import {
  useClipboard
} from "./chunk-PF725XN5.js";
import {
  useEnterprise
} from "./chunk-PZUVEOTJ.js";
import {
  ADMIN_PERMISSIONS_EE,
  getEERoutes
} from "./chunk-ALVYRRID.js";
import {
  Login
} from "./chunk-DLROC4ZE.js";
import {
  MemoizedInputRenderer
} from "./chunk-YR57WJI4.js";
import {
  Form
} from "./chunk-B4K5OH7T.js";
import {
  Column,
  LayoutContent,
  Logo,
  UnauthenticatedLayout
} from "./chunk-7J65MB3I.js";
import {
  ConfigurationProvider
} from "./chunk-ZLM44HNG.js";
import {
  require_baseMerge,
  require_createAssigner,
  require_merge,
  require_omit
} from "./chunk-SDYGJDQA.js";
import {
  require_baseRest
} from "./chunk-WQJT43WC.js";
import {
  HistoryProvider
} from "./chunk-X2FVGMHF.js";
import {
  errorsTrads
...
import {
  ...
  create4 as create2,
  create6 as create3
} from "./chunk-HPMA376H.js";
import {
  Layouts
} from "./chunk-7YLI4MIG.js";
import {
  TrackingProvider,
  useTracking
} from "./chunk-FQILKJUJ.js";
import {
  createAbsoluteUrl,
  useInitQuery
...
import {
  ...
  useTypedSelector,
  useTypedStore
} from "./chunk-YODKEBAM.js";
import {
  NotificationsProvider,
  useNotification
} from "./chunk-5Y2HFOQQ.js";
import {
  adminApi,
  getFetchClient,
  isBaseQueryError,
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.AUDIT_LOGS) ? [
    {
      path: "audit-logs",
      lazy: async () => {
        const { ProtectedListPage } = await import("./ListPage-TSSFWTJS.js");
        return {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.SSO) ? [
    {
      path: "single-sign-on",
      lazy: async () => {
        const { ProtectedSSO } = await import("./SingleSignOnPage-YI63T5BA.js");
        return {
...
var AuthPage = () => {
  ...
  const { hasAdmin } = data ?? {};
  const Login$1 = useEnterprise(Login, async () => (await import("./Login-MZRJC4ID.js")).LoginEE);
  const forms = useEnterprise(FORMS, async () => (await import("./constants-MAP7PJXW.js")).FORMS, {
...
var ROUTES_CE = [
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-GCNPUOB2.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-JH5RFLPI.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-OOLMQEU2.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-J3VG75VZ.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-3ZXVU2JO.js");
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-2QCZJ6VN.js");
      return {
        Component: ProtectedCreatePage
      };
    },
  ...
  {
    lazy: async () => {
      const editWebhook = await import("./EditPage-V2KB625C.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-UM3XY7TC.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-GZWPBGXK.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-UR7DJAVR.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditViewPage-3CCMLOKI.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-VR5UMPBI.js");
      return {
        Component: ProtectedCreateView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-4A7VHWMC.js");
      return {
        Component: ProtectedListView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditView-VHO2A6HX.js");
      return {
        Component: ProtectedEditView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedInstalledPlugins } = await import("./InstalledPlugins-4ZJZ3YPV.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseAuditLogs } = await import("./PurchaseAuditLogs-SHOXDFVE.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseSingleSignOn } = await import("./PurchaseSingleSignOn-C5H2WBUP.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseContentHistory } = await import("./PurchaseContentHistory-MCLGDSQQ.js");
      return {
...
var getImmutableRoutes = () => [
  {
    path: "usecase",
    lazy: async () => {
      const { PrivateUseCasePage } = await import("./UseCasePage-WETEB2NV.js");
      return {
...
var getInitialRoutes = () => [
  {
    index: true,
    lazy: async () => {
      const { HomePage } = await import("./HomePage-F6CHVM47.js");
      return {
        Component: HomePage
      };
    }
  },
  {
    path: "me",
    lazy: async () => {
      const { ProfilePage } = await import("./ProfilePage-RMPQFPWV.js");
      return {
  ...
  },
  {
    path: "marketplace",
    lazy: async () => {
      const { ProtectedMarketplacePage } = await import("./MarketplacePage-YPVSH4F7.js");
      return {
  ...
  },
  {
    path: "settings/*",
    lazy: async () => {
      const { Layout } = await import("./Layout-HYL75MM4.js");
      return {
        Component: Layout
      };
    },
    children: [
      {
        ...
        lazy: async () => {
          const { ApplicationInfoPage } = await import("./ApplicationInfoPage-X2NVQ7ZO.js");
          return {
    ...
    const routes = [
      {
        ...
        children: [
          ...getImmutableRoutes(),
          {
            path: "/*",
            lazy: async () => {
              const { PrivateAdminLayout } = await import("./AuthenticatedLayout-GPTJHWVK.js");
              return {
...
function __variableDynamicImportRuntime1__(path) {
  switch (path) {
    case "./translations/en-GB.js":
      return import("./en-GB-UGVXSZVX.js");
    default:
      return new Promise(function(resolve, reject) {
        (typeof queueMicrotask === "function" ? queueMicrotask : setTimeout)(
          reject.bind(null, new Error("Unknown variable dynamic import: " + path))
    ...
    this.widgets.register([
      {
        ...
        component: async () => {
          const { ProfileWidget } = await import("./Widgets-NAQX2NDB.js");
...
//# sourceMappingURL=chunk-FDC32D4P.js.map
