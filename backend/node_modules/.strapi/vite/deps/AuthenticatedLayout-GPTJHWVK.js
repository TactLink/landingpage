...
import {
  PrivateRoute
} from "./chunk-MMZFDMPD.js";
import {
  LAYOUT_DATA,
  Number,
  STATES,
  VerticalDivider
} from "./chunk-QZA7YPX5.js";
import {
  getDisplayName,
  getInitials,
  hashAdminUserEmail
...
import {
  useLicenseLimits
} from "./chunk-6DSOGXUD.js";
import "./chunk-PZUVEOTJ.js";
import {
  useConfiguration
} from "./chunk-ZLM44HNG.js";
import "./chunk-KPPN573F.js";
import {
  format,
  isAfter,
  isBefore,
  startOfToday,
  subDays
} from "./chunk-SW57U2F7.js";
import "./chunk-KP7C3AGG.js";
...
import "./chunk-AY72PWCR.js";
import "./chunk-QNH4GCYC.js";
import "./chunk-25BCNBQL.js";
import "./chunk-HPMA376H.js";
...
import "./chunk-5Y2HFOQQ.js";
import {
  require_get
} from "./chunk-EQPU6WPK.js";
import "./chunk-KZNHOPEA.js";
...
var package_default = {
  ...
  devDependencies: {
    "@strapi/admin-test-utils": "5.18.1",
          ...
          (0, import_jsx_runtime.jsxs)(Box, {
            children: [
              ...
              cta && (cta.target ? (0, import_jsx_runtime.jsx)(LinkButton, {
                tag: NavLink,
                endIcon: (0, import_jsx_runtime.jsx)(ForwardRef$5l, {}),
                onClick: onCtaClick,
                to: cta.target,
...
var LinkImpl = ({ children, ...props }) => {
  ...
  return (0, import_jsx_runtime4.jsx)(GuidedTourTooltip, {
    children: (0, import_jsx_runtime4.jsx)(MainNavLinkWrapper, {
      ...props,
      children
    })
  });
...
var CircleProgressBar = ({ percentage }) => {
  ...
  return (0, import_jsx_runtime6.jsxs)("svg", {
    width: "32",
    height: "32",
    viewBox: "0 0 100 100",
    children: [
      (0, import_jsx_runtime6.jsx)("defs", {
        children: (0, import_jsx_runtime6.jsxs)("linearGradient", {
          id: "progressGradient",
          x1: "0%",
          y1: "0%",
          x2: "100%",
          y2: "0%",
          children: [
            (0, import_jsx_runtime6.jsx)("stop", {
              offset: "0%",
...
var TrialCountdown = () => {
  ...
  return (0, import_jsx_runtime6.jsx)(Flex, {
    justifyContent: "center",
    padding: 3,
    children: (0, import_jsx_runtime6.jsx)(TooltipImpl, {
      ...
      children: (0, import_jsx_runtime6.jsx)("div", {
        ...
        children: (0, import_jsx_runtime6.jsx)(CircleProgressBar, {
...
var LeftMenu = ({ generalSectionLinks, pluginsSectionLinks }) => {
  ...
  return (0, import_jsx_runtime7.jsxs)(MainNav, {
    children: [
      (0, import_jsx_runtime7.jsx)(NavBrand, {}),
      (0, import_jsx_runtime7.jsx)(Divider, {}),
      (0, import_jsx_runtime7.jsx)(NavListWrapper, {
        tag: "ul",
        gap: 3,
        direction: "column",
        flex: 1,
        ...
        children: listLinks.length > 0 ? listLinks.map((link) => {
          ...
          const badgeContentLock = (link == null ? void 0 : link.licenseOnly) ? (0, import_jsx_runtime7.jsx)(ForwardRef$2x, {
            fill: "primary600"
          }) : void 0;
          ...
          return (0, import_jsx_runtime7.jsx)(Flex, {
            tag: "li",
            children: (0, import_jsx_runtime7.jsx)(NavLink2.Tooltip, {
              label: labelValue,
              children: (0, import_jsx_runtime7.jsxs)(NavLink2.Link, {
                to: link.to,
                onClick: () => handleClickOnLink(link.to),
                "aria-label": labelValue,
                children: [
                  (0, import_jsx_runtime7.jsx)(NavLink2.Icon, {
                    label: labelValue,
                    children: (0, import_jsx_runtime7.jsx)(LinkIcon, {
                      width: "20",
                      height: "20",
                      fill: "neutral500"
                    })
                  }),
                  badgeContentLock ? (0, import_jsx_runtime7.jsx)(NavLinkBadgeLock, {
                    label: "locked",
                    textColor: "neutral500",
                    paddingLeft: 0,
                    paddingRight: 0,
                    children: badgeContentLock
                  }) : badgeContentNumeric ? (0, import_jsx_runtime7.jsx)(NavLinkBadgeCounter, {
      ...
      (0, import_jsx_runtime7.jsx)(TrialCountdown, {}),
      (0, import_jsx_runtime7.jsx)(NavUser, {
        initials,
  ...
  if (hasApluginNotReady) {
    const initializers = Object.keys(plugins).reduce((acc, current) => {
      ...
      if (InitializerComponent) {
        ...
        acc.push((0, import_jsx_runtime8.jsx)(InitializerComponent, {
    ...
    return (0, import_jsx_runtime8.jsxs)(import_jsx_runtime8.Fragment, {
      children: [
        initializers,
        (0, import_jsx_runtime8.jsx)(Page.Loading, {})
      ]
    });
  }
  return children;
...
var Banner = ({ isTrialEndedRecently }) => {
  const { formatMessage } = useIntl();
  return (0, import_jsx_runtime9.jsx)(BannerBackground, {
    width: "100%",
    justifyContent: "center",
    children: (0, import_jsx_runtime9.jsxs)(Flex, {
      ...
      children: [
        ...
        (0, import_jsx_runtime9.jsx)(Box, {
          children: (0, import_jsx_runtime9.jsx)(LinkButton, {
            width: "max-content",
            variant: "tertiary",
...
var UpsellBanner = () => {
  ...
  const [cachedTrialEndsAt, setCachedTrialEndsAt] = usePersistentState("STRAPI_FREE_TRIAL_ENDS_AT", void 0);
  ...
  if (((_b = timeLeftData.data) == null ? void 0 : _b.trialEndsAt) || isTrialEndedRecently) {
    return (0, import_jsx_runtime9.jsx)(Banner, {
...
var AdminLayout = () => {
  ...
  return (0, import_jsx_runtime10.jsxs)(AppInfoProvider, {
    ...appInfo,
    userId,
    latestStrapiReleaseTag: tagName,
    shouldUpdateStrapi: checkLatestStrapiVersion(strapiVersion, tagName),
    children: [
      (0, import_jsx_runtime10.jsx)(NpsSurvey, {}),
      (0, import_jsx_runtime10.jsx)(PluginsInitializer, {
        children: (0, import_jsx_runtime10.jsx)(DndProvider, {
          backend: HTML5Backend,
          children: (0, import_jsx_runtime10.jsxs)(Box, {
            background: "neutral100",
            children: [
              (0, import_jsx_runtime10.jsx)(SkipToContent, {
                children: formatMessage({
                  id: "skipToContent",
              ...
              (0, import_jsx_runtime10.jsxs)(Flex, {
                alignItems: "flex-start",
                children: [
                  (0, import_jsx_runtime10.jsx)(LeftMenu, {
                    generalSectionLinks,
                    pluginsSectionLinks
                  }),
                  (0, import_jsx_runtime10.jsxs)(Box, {
                    flex: 1,
                    children: [
                      (0, import_jsx_runtime10.jsx)(UpsellBanner, {}),
                      (0, import_jsx_runtime10.jsx)(Outlet, {}),
                      (0, import_jsx_runtime10.jsx)(GuidedTourModal, {})
                    ]
                  })
                ]
              })
...
var PrivateAdminLayout = () => {
  return (0, import_jsx_runtime10.jsx)(PrivateRoute, {
    children: (0, import_jsx_runtime10.jsx)(AdminLayout, {})
  });
};
...
//# sourceMappingURL=AuthenticatedLayout-GPTJHWVK.js.map
