...
var DataManagerProvider = ({ children }) => {
  ...
  const { setCurrentStep, setStepState } = useGuidedTour("DataManagerProvider", (state2) => state2);
...
// node_modules/@strapi/content-type-builder/dist/admin/pages/App/index.mjs
var ListView = (0, import_react14.lazy)(() => import("./ListView-4WSPXTZO.js"));
var App = () => {
  const { formatMessage } = useIntl();
  ...
  const startSectionRef = (0, import_react14.useRef)(startSection);
...
lodash/lodash.min.js:
   ...
   *)
*/
//# sourceMappingURL=App-KRVQB72K.js.map
