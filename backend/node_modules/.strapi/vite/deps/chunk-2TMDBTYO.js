...
function __variableDynamicImportRuntime4__(path) {
  switch (path) {
    ...
    case "./translations/en.json":
      return import("./en.json-E4RDEYJU.js");
...
var index = {
  register(app) {
    ...
    app.router.addRoute({
      ...
      lazy: async () => {
        const { Layout } = await import("./layout-M2WJTYIY.js");
        return {
          Component: Layout
        };
      },
    ...
    app.widgets.register([
      {
        ...
        component: async () => {
          const { ChartEntriesWidget } = await import("./Widgets-3DQHZAPY.js");
      ...
      },
      {
        ...
        component: async () => {
          const { LastEditedWidget } = await import("./Widgets-3DQHZAPY.js");
      ...
      },
      {
        ...
        component: async () => {
          const { LastPublishedWidget } = await import("./Widgets-3DQHZAPY.js");
...
//# sourceMappingURL=chunk-2TMDBTYO.js.map
