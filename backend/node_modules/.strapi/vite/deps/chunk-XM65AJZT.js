...
import {
  LimitsModal
} from "./chunk-TNNYADYM.js";
import {
  AssigneeColumn,
  StageColumn,
  getDisplayName
} from "./chunk-HFXEL4AX.js";
import {
  getStageColorByHex
} from "./chunk-CITFHOFG.js";
import {
...
} from "./chunk-2M3FD7GG.js";
import {
  useTypedSelector
} from "./chunk-YAWY4Z7U.js";
import {
...
import {
  ...
  usePersistentState,
  useSelectionState
} from "./chunk-6MAMT3ZL.js";
import {
  useConfig
} from "./chunk-AKWZZLXX.js";
import {
  AssetSource,
  AssetType,
...
var index2 = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./App-KRVQB72K.js"),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
  ...
  register(app) {
    app.createSettingSection({
    ...
    }, [
      {
        ...
        id: "settings",
        to: "email",
        Component: () => import("./Settings-UN6HZKO6.js").then((mod) => ({
...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => import("./App-TCOTZC47.js").then((mod) => ({
        default: mod.Upload
      })),
      position: 4
    });
    app.addSettingsLink("global", {
      ...
      async Component() {
        const { ProtectedSettingsPage } = await import("./SettingsPage-5PKZSO4M.js");
        return {
...
var index3 = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-2WKA4RQT.js").then((mod) => ({
        default: mod.ProtectedSettingsPage
      })),
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-5OEOAO2M.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { ProtectedReleasesSettingsPage } = await import("./ReleasesSettingsPage-VGU23IKZ.js");
          return {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseContentReleases } = await import("./PurchaseContentReleases-TBTVA35Q.js");
          return {
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { Router } = await import("./router-SXIV6QPF.js");
          return {
            default: Router
          };
        }
      ...
      app.widgets.register([
        {
          ...
          component: async () => {
            const { AssignedWidget } = await import("./Widgets-WCGUSFGI.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseReviewWorkflows } = await import("./purchase-review-workflows-LJ4C4GMM.js");
          return {
...
//# sourceMappingURL=chunk-XM65AJZT.js.map
