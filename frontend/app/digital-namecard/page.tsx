                        ...
                        <div className="w-full md:w-1/2 flex flex-col items-start">
                            ...
                            <ul className="space-y-4 mb-8">
                                {[
                                    ...
                                    { icon: "M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z", label: "Customise your card with your photo and bio." },
                                ].map((item, idx) => (
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-12">
                            ...
                            <div className="flex items-start gap-6 group">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-600 leading-relaxed">Access your cards and directory seamlessly across all your phones and tablets.</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-6 group">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-600 leading-relaxed">Give your assistant limited access to add contacts and take notes on your behalf — no confidential information exposed.</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-6 group">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-600 leading-relaxed">Export your entire network as a CSV and share it directly with anyone.</p>
                                </div>
                            </div>
