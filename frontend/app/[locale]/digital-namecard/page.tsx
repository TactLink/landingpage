...
export default function DigitalNamecardPage() {
  ...
  const testimonials = [
    { name: t("testimonial0Name"), role: t("testimonial0Role"), text: t("testimonial0Text") },
  ...
  const feat1Bullets = [
    ...
    { icon: "M12 4v1m6 11h2m-6 0h-2v4m0-11v3m0 0h.01M12 12h4.01M16 20h4M4 12h4m12 0h.01M5 8h2a1 1 0 001-1V5a1 1 0 00-1-1H5a1 1 0 00-1 1v2a1 1 0 001 1zm12 0h2a1 1 0 001-1V5a1 1 0 00-1-1h-2a1 1 0 00-1 1v2a1 1 0 001 1zM5 20h2a1 1 0 001-1v-2a1 1 0 00-1-1H5a1 1 0 00-1 1v2a1 1 0 001 1z", label: t("feat1Bullet1") },
    { icon: "M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.899a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1", label: t("feat1Bullet2") },
    { icon: "M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z", label: t("feat1Bullet3") },
  ];

  const feat2Bullets = [
    { icon: "M3 9a2 2 0 012-2h.93a2 2 0 001.664-.89l.812-1.22A2 2 0 0110.07 4h3.86a2 2 0 011.664.89l.812 1.22A2 2 0 0018.07 7H19a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V9z M15 13a3 3 0 11-6 0 3 3 0 016 0z", label: t("feat2Bullet0") },
    { icon: "M12 4v1m6 11h2m-6 0h-2v4m0-11v3m0 0h.01M12 12h4.01M16 20h4M4 12h4m12 0h.01M5 8h2a1 1 0 001-1V5a1 1 0 00-1-1H5a1 1 0 00-1 1v2a1 1 0 001 1zm12 0h2a1 1 0 001-1V5a1 1 0 00-1-1h-2a1 1 0 00-1 1v2a1 1 0 001 1zM5 20h2a1 1 0 001-1v-2a1 1 0 00-1-1H5a1 1 0 00-1 1v2a1 1 0 001 1z", label: t("feat2Bullet1") },
    { icon: "M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z", label: t("feat2Bullet2") },
    { icon: "M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z", label: t("feat2Bullet3") },
    { icon: "M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z", label: t("feat2Bullet4") },
  ];

  const premiumFeatures = [
    { icon: "M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z M4 6h16M4 18h16", title: t("prem0Title"), desc: t("prem0Desc") },
    { icon: "M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z", title: t("prem1Title"), desc: t("prem1Desc") },
    { icon: "M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12", title: t("prem2Title"), desc: t("prem2Desc") },
    { icon: "M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z", title: t("prem3Title"), desc: t("prem3Desc") },
    { icon: "M10 6H5a2 2 0 00-2 2v9a2 2 0 002 2h14a2 2 0 002-2V8a2 2 0 00-2-2h-5m-4 0V5a2 2 0 114 0v1m-4 0a2 2 0 104 0m-5 8a2 2 0 100-4 2 2 0 000 4zm0 0c1.306 0 2.417.835 2.83 2M9 14a3.001 3.001 0 00-2.83 2M15 11h3m-3 4h2", title: t("prem4Title"), desc: t("prem4Desc"), wide: true },
  ];
    ...
    <main className="w-full min-h-screen bg-white selection:bg-brand-accent selection:text-brand-primary">
        ...
        <div className="hidden md:flex max-w-7xl mx-auto px-6 md:px-12 lg:px-16 min-h-screen items-center justify-center gap-12 lg:gap-24 relative z-10 pt-10 pb-16">
          <div className="w-1/2 max-w-xl text-left flex flex-col items-start">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 backdrop-blur-md mb-6">
              ...
              <span className="text-sm font-medium text-white tracking-widest uppercase">{t("lastNamecardBadge")}</span>
            </div>
            ...
            <p className="text-[18px] text-white/70 mb-8 max-w-lg leading-relaxed font-light">{t("heroDescDesktop")}</p>
            ...
            <div className="mt-6 flex items-center gap-3 opacity-80">
              ...
              <div className="flex flex-col gap-0.5">
                <span className="text-[13px] font-semibold text-white">{t("cardsShared")}</span>
        ...
        <div className="md:hidden flex flex-col min-h-screen relative z-10">
          <div className="flex flex-col items-center text-center px-6 pt-28 pb-8">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/5 border border-white/10 mb-5">
              ...
              <span className="text-[13px] font-medium text-white tracking-widest uppercase">{t("lastNamecardBadge")}</span>
            </div>
            <h1 className="text-[38px] leading-[1.1] font-extrabold text-white mb-4 tracking-tight">
              {t("heroTitle")} <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-accent to-[#f8cdab]">{t("heroTitleAccent")}</span>
            </h1>
            <p className="text-[15px] text-white/70 mb-6 leading-relaxed font-light max-w-sm">{t("heroDescMobile")}</p>
        ...
        <div className="max-w-7xl mx-auto flex flex-col gap-32">
          <div className="flex flex-col md:flex-row items-center gap-12 lg:gap-20">
            <div className="w-full md:w-1/2 flex flex-col items-start">
              ...
              <p className="mb-6 text-[16px] md:text-[18px] text-gray-600 leading-relaxed font-light">{t("feat1Desc")}</p>
              <ul className="space-y-4 mb-8">
                {feat1Bullets.map((item, idx) => (
        ...
        <div className="max-w-7xl mx-auto flex flex-col gap-32">
          <div className="flex flex-col md:flex-row-reverse items-center gap-12 lg:gap-20">
            <div className="w-full md:w-1/2 flex flex-col items-start">
              ...
              <h2 className="text-[32px] md:text-[40px] font-extrabold text-gray-900 mb-6 leading-tight">
                {t.rich("feat2Title", { highlight: (c) => <span className="text-brand-accent">{c}</span> })}
              </h2>
              <p className="mb-6 text-[16px] md:text-[18px] text-gray-600 leading-relaxed font-light">{t("feat2Desc")}</p>
              <ul className="space-y-4 mb-8">
                {feat2Bullets.map((item, idx) => (
                  <li key={idx} className="flex items-center gap-3 text-gray-700">
            ...
            <div className="w-full md:w-1/2 relative flex justify-center py-4">
              ...
              <div className="relative z-10 w-full max-w-[240px] lg:max-w-[260px] aspect-[305/678] overflow-hidden rounded-[2rem] shadow-2xl border border-gray-100 bg-gray-100 group">
                <Image src="/mockups/directory-global.webp" alt="Smart Directory" fill className="object-cover object-top transition-all duration-500 group-hover:scale-105" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section data-navbar-theme="light" className="py-24 bg-gray-50 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-extrabold text-brand-primary mb-6 tracking-tight">
              {t.rich("premiumTitle", { highlight: (c) => <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-primary to-brand-accent">{c}</span> })}
            </h2>
            <p className="text-lg md:text-xl text-gray-500 max-w-2xl mx-auto">{t("premiumDesc")}</p>
          </div>
          <div className="bg-white rounded-[3rem] shadow-2xl shadow-brand-primary/5 border border-gray-100 p-8 md:p-16 relative overflow-hidden">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-12">
              {premiumFeatures.map((feat, idx) => (
                <div key={idx} className={`flex items-start gap-6 group ${feat.wide ? "md:col-span-2 md:max-w-xl md:mx-auto" : ""}`}>
                  <div className="w-16 h-16 rounded-2xl bg-brand-primary/5 flex items-center justify-center flex-shrink-0 text-brand-primary transition-transform group-hover:scale-110 group-hover:bg-brand-primary group-hover:text-white duration-300">
                    <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d={feat.icon} /></svg>
                  </div>
                  <div>
      ...
      <section data-navbar-theme="dark" className="py-28 relative overflow-hidden bg-gradient-to-br from-[#1A1F4C] via-[#374085] to-[#cfa086]">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          ...
          <h2 className="text-4xl md:text-[54px] font-extrabold text-white mb-6 leading-[1.15] tracking-tight">
            {t("referralTitle")} <br className="hidden md:block" />
      ...
      <section data-navbar-theme="dark" className="py-24 bg-brand-primary text-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-[32px] md:text-[48px] font-extrabold mb-4 tracking-tight">{t("socialProofTitle")}</h2>
            <p className="text-lg text-white/70">{t("socialProofDesc")}</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {testimonials.map((testimonial, idx) => (
              <div key={idx} className="bg-white/10 backdrop-blur-md rounded-3xl p-8 border border-white/10 hover:bg-white/15 transition-colors">
                ...
                <p className="text-lg leading-relaxed mb-6">&ldquo;{testimonial.text}&rdquo;</p>
